...
export function servicesPage(content) {
 ...
 return `<section class="services-opening container"><h1>${esc(c.title)}</h1><p class="lede">${esc(c.introduction)}</p><p><a class="text-link" href="/agencia-de-branding-campo-grande/">Conheça nosso trabalho de branding em Campo Grande${icon('diagonal')}</a></p><nav class="service-index" aria-label="Frentes de atuação"><a href="#advisor">Estruturar${icon('down')}</a><a href="#escola">Ensinar${icon('down')}</a><a href="#ordo-legatum">Elevar${icon('down')}</a></nav></section>
